...
void    Contact::init(void) {
    std::cin.ignore();
    this->_firstName = this->_getInput("Please enter your first name: "); // imho it might be a better approach to make _getInput function 
    this->_lastName = this->_getInput("Please enter your last name: "); // class function instead instance function.
